## El manifiesto del Unified Namespace en 5 puntos
...
* **Sin API REST para el Núcleo** Las APIs REST se utilizan para hablar *con* el UNS si el sistema no es compatible MQTT.
...
Los datos solo son valiosos cuando están contextualizados y organizados.

* **Modelado Estandarizado** La modelización física sigue una jerarquía, por ejemplo: Empresa > Sitio > Zona > Línea > Celda > Equipo > Punto de medición. Cualquiera que sea la modelización elegida, esto permite tener un lenguaje común en toda la organización.
* **Taxonomía Ágil** Esta estructura no es inamovible; es ágil y puede evolucionar para incluir nuevos activos, procesos y metadatos sin romper las integraciones existentes.
* **Idealmente autodescriptivo** La información autocontenida permite comprender de qué se trata sin necesidad de consultar documentación o a una persona externa.